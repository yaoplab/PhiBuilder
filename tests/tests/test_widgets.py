...
from phibuilder.widgets import (M3Button, ButtonVariant, M3Card, CardVariant,
    M3TextField, FieldVariant, M3Label, M3ComboBox, M3ListWidget,
    M3TableWidget, M3Dialog, M3BottomSheet, M3NavigationBar, M3Sidebar)
...
class TestM3Dialog:
    def test_creation(self, qapp, theme):
        dlg = M3Dialog("Title", "Message", theme)
